...
# Cấu hình API Key
PEXELS_API_KEY = "hMmOZcp5nm96tGhNSGTK4H7WRCblbhVHHxPmIEWhb8mKp8YTEWaYB2jA"
GENAI_API_KEY = "AIzaSyB0JsCKk6YyRGNPsSjjaFJUBjQHiInIJDA"  # Thay bằng API Key của bạn
